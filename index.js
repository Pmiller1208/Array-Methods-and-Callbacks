...
/* function hof(num1, num2, operate){ // operate will be callback
...
function getWinnersByYear(theWinners, theYear) {
    let winnersByTeam = theWinners.map( (item, index) => {
        return `In ${theYear[index]}, ${item} won the World Cup!`
    });
    return winnersByTeam;
